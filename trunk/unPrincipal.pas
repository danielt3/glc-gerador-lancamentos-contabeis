...
type
  ...
  TfrmPrincipal = class(TForm)
    ...
    procedure btnImportarPlano1Click(Sender: TObject);
...
begin
  ...
  try
    try
      ...
      MensagemErro(e.Message, 'Exportar Tabela');
    end;
  finally
  end;
end;
...
procedure TfrmPrincipal.btnImportarPlano1Click(Sender: TObject);
begin
  if ImportarTabelas(edtImportarPlano1.Text, nil) then
    MensagemSucesso('Dados importados com sucesso de ' + edtImportarPlano1.Text, 'Importar dados');
end;
