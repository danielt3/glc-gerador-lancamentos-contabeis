...
type
  ...
  private
    ...
    procedure ConsultarFornecedores(Empresa: Integer; Classificacao: String);
    //Plano de Contas
...
procedure TfrmPrincipal.ConsultarFornecedores(Empresa: Integer; Classificacao: String);
var
  lComandoSQL: String;
begin
  try
